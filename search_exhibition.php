...
<br>
<a class ="back" href="exhibition.php"> &#10096;&#10096; Go Back </a>
...
$price = $_POST['Price'];
             ...
             $query_category="SELECT exhibition.art_imagepath,exhibition.art_id, exhibition.art_title,exhibition.art_price, user.user_fname, user.user_mname,user.user_lname,exhibition.art_description,exhibition.art_imagepath,exhibition.art_status,exhibition.art_category
                         FROM exhibition, user
                        where exhibition.user_id = user.user_id AND (art_category = '$category') AND (art_media = '$medium') AND (art_price between 0 AND '$price') GROUP BY exhibition.art_id ORDER BY exhibition.art_title ASC
                            ";
